...
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
vector<int>demo = {1, 4, 4, 6, 7, 8};
bool ok = false;
int interactor(int l, int r) {
	vector<int>pref(demo.size());
	pref[0] = demo[0];
	for (int i = 1; i < demo.size(); i++)pref[i] = pref[i - 1] + demo[i];
